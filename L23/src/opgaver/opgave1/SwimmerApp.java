...
public class SwimmerApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        for (Swimmer s : swimmers) {
            System.out.println(s.getName() + "'s samlede træningstid: " + s.AllTrainingHours());
        }
    }
}
